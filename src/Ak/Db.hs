...
-- | The DbSpec describes all parent paths where a .ak file exists.  There is no
-- guarantee that this is the full set of .ak files that will be used when
...
discoverDbSpecFrom  = filterM doesFileExist . map (</> ".ak") . directoryParents
